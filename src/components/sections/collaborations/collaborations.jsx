...
export default function Collaborations() {
    const halfIndex = Math.ceil(collaborators.length / 2);
    const firstRow = collaborators.slice(0, halfIndex);
    const secondRow = collaborators.slice(halfIndex);
...
const ReviewCard = ({ collaborators }) => (
