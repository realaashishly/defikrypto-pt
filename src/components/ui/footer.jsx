...
// Use a <footer> element with DaisyUI’s utility classes for a primary background
const Footer = React.forwardRef(({ className, ...props }, ref) => (
  <footer
    ref={ref}
    className={cn('footer footer-center text-primary-content p-10', className)}
    {...props}
  />
));
Footer.displayName = 'Footer';

// This container holds items like social links in a single row (grid-flow-col)
const FooterContent = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('grid grid-flow-col gap-4', className)}
    {...props}
  />
));
FooterContent.displayName = 'FooterContent';

// A simple column for grouping related footer items
...
// FooterBottom for the bottom row (copyright info, etc.)
const FooterBottom = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'mt-8 flex flex-col items-center justify-between gap-4 border-t border-primary-content pt-4 text-xs',
      className
    )}
    {...props}
  />
  ...
  return (
    <Footer>
      <aside className="flex flex-col items-center gap-4">
        {/* You can replace the inline SVG below with your own logo if desired */}
        <svg
          width="50"
          height="50"
          viewBox="0 0 24 24"
